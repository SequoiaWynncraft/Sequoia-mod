...
public abstract class SettingWidget<T extends Setting<?>> {
    ...
    static {
        ...
        DISPLAY_NAME_OVERRIDES.put("color_rank_pills", "Color rank pills");
        DISPLAY_NAME_OVERRIDES.put("color_usernames", "Color usernames");
        DISPLAY_NAME_OVERRIDES.put("show_rank_pill_gradients", "Use gradients");
        DISPLAY_NAME_OVERRIDES.put("show_username_gradients", "Use gradients");
        DISPLAY_NAME_OVERRIDES.put("animate_rank_gradients", "Animate gradients");
        DISPLAY_NAME_OVERRIDES.put("animate_username_gradients", "Animate gradients");
